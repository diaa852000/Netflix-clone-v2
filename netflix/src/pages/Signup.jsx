        ...
        <>
            <div className='relative'>
                ...
                <div className="fixed top-0 left-0 bg-black/50 h-full w-full">
                    <Navbar authPage ClassName="hidden md:block"/>
                    <div className='flex flex-col justify-start items-center p-1 md:p-2'>
                        <div className='fixed top-0 left-0 md:static h-full w-full bg-black px-2 md:flex justify-center rounded-md md:bg-black/80 
...
const Form = () => {
    ...
    >
        ...
        <h1 className='text-3xl self-start p-1 font-semibold capitalize my-4 text-white'>Sign up</h1>
        ...
        <div className='flex flex-col gap-3 w-full'>
            <input
                ...
                className={`rounded-[4px] p-3 w-full md:col-span-2 border-slate-400 border bg-[rgba(0,0,0,0.4)] outline-none placeholder:capitalize placeholder:text-slate-300`}
                {...register("email")}
            />
        ...
        <button
            type='submit'
            className={`rounded-[4px] bg-[#e50914] font-semibold text-[1.05rem] md:text-lg border-none border-0 capitalize w-full text-white
            flex items-center justify-center gap-3 py-2 mt-8 mb-6`}
        >
            sign up
        </button>
        ...
        <p className='text-[#8c8c8c] self-start md:text-sm'>Netflix user? <Link to={'/signin'} className='text-white'>Sign in.</Link></p>
